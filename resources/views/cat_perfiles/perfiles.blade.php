...
@section('content')
    <section>
                                                                ...
                                                                <table id="table" data-toggle="table"
                                                                    ...
                                                                    @foreach ($perfiles as $Items )
                                                                        <tr role="row" class="odd">
                                                                            ...
                                                                            <td class="sorting_1">{{$Items->id_perfil}}</td>
                                                                            <td class="sorting_1">{{$Items->nom_perfil}}</td>
                                                                            <td class="sorting_1">
                                                                                <button type="button"
                                                                                        title="Editar registro"
                                                                                        class="pd-setting-ed">
                                                                                    <a href='editar_perfil/{{$Items->id_perfil}}'>
        ...
        <form action="{{route('perfiles')}}" method="POST" class="form-horizontal">{{csrf_field()}}
        ...
        <form action="delete_perfil/{{$Items->id_perfil}}" method="POST">
            {{method_field('PATCH')}}
            {{csrf_field()}}
