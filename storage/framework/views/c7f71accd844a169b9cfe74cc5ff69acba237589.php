                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control select2"  name="id__edit" id="id__edit" value="<?php echo e('id_pais'); ?>">
                                                                ...
                                                                <div class="form-group" >
                                                                    <select required='true' class="form-control select2"  name="cve_ent__edit" id="cve_ent__edit" value="<?php echo e(old('cve_ent')); ?>">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <select required='true' class="form-control select2"  name="cve_compuesta_ent_mun__edit" id="cve_compuesta_ent_mun__edit" value="<?php echo e('cve_compuesta_ent_mun'); ?>">
