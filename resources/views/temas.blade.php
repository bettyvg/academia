            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <h4 style="text-align: center">{{' '.$Items->temna.' '.$Items->apellido_paterno.' '.$Items->apellido_materno}} ?</h4>
                    </div>
                    <div class="modal-footer danger-md">
                        <button class="btn btn-danger" data-dismiss="modal" href="#" style="text-align: left">Cancel</button><br><br>
                        <form action="delete_tema/{{$Items->id_ejecutivo}}" method="POST">
                            {{method_field('PATCH')}}
                            {{csrf_field()}}
