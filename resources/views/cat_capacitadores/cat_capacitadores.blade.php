...
@section('content')
    <section>
                                                        ...
                                                        <table id="table" data-toggle="table"
                                                            ...
                                                            @foreach ($capacitadores as $capacitador)
                                                                <tr role="row" class="odd">
                                                                    ...
                                                                    <td class="sorting_1">{{$capacitador->nom_cap}}</td>
                                                                    <td class="sorting_1">{{$capacitador->apellido_paterno}}</td>
                                                                    <td class="sorting_1">{{$capacitador->apellido_materno}}</td>
                                                                    <td class="sorting_1">
                                                                        ...
                                                                        <button type="button"
                                                                                ...
                                                                                class="pd-setting-ed">
                                                                            <a href='cat_capacitadores/{{$capacitador->id_capacitador}}/edit'>
        ...
        <form action="{{route('cat_capacitadores.store')}}" method="POST">
            @csrf
        ...
        <form action="./delete_capacitador/{{$capacitador->id_capacitador}}" method="POST">
            {{method_field('PATCH')}}
            {{csrf_field()}}
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <h4 style="text-align: center">{{' '.$capacitador->nom_cap .' '.$capacitador->apellido_paterno.' '.$capacitador->apellido_materno}}
                            ?</h4>
                    </div>
