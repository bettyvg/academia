                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                ...
                                <br>
                                <?php $__currentLoopData = $tema; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="payment-adress">
                                    <br>
                                        <a href='examenes/<?php echo e($temas->id_tema); ?>'><button type="button"
...
<?php echo $__env->make('main2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\academia\resources\views/inicio2.blade.php ENDPATH**/ ?>