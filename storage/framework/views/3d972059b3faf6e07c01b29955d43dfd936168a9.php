                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="ocupacion" id="ocupacion" type="text"
                                                                           <?php if(isset($registro)): ?>  value="<?php echo e($registro->ocupacion); ?>" <?php endif; ?>
                                                                           class="form-control"
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\academia\resources\views/registro_platica/registroplatica.blade.php ENDPATH**/ ?>