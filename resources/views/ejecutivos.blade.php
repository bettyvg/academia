                                                                                ...
                                                                                <tr role="row" class="odd">
                                                                                    ...
                                                                                    <td class="sorting_1">
                                                                                        <button type="button"
                                                                                            ...
                                                                                            <a href='editar_ejecutivo/{{$Items->id_ejecutivo}}'><i class="fa fa-pencil-square-o"> </i>  </a></button>
...
<!--!MODAL PARA CREAR EJECUTIVO-->
        <form action="{{route('crear_ejecutivos')}}" method="POST" class="form-horizontal">
            @csrf
 ...
 <!--!FIN DEL MODAL CREAR EJECUTIVO-->
        ...
        <form action="{{route('editar_ejecutivos', $Items->id_ejecutivo)}}" method="get">
            {{csrf_field()}}
