...
<div class="left-sidebar-pro" >
    <nav id="sidebar2" class="">
        <div class="sidebar-header">
            <a href="home"><img class="main-logo" src="<?php echo e(asset('img/logo/logo.png')); ?>" alt="" style="width: 200px"/></a>
        </div>
    </nav>
</div>
    <!-- Start Welcome area -->
                                        ...
                                        <div class="header-top-menu tabl-d-n">
                                                <div class="header-top-menu tabl-d-n">
                                                    <ul class="nav navbar-nav mai-top-nav">
                                                        ...
                                                        <li class="nav-item"><a href="<?php echo e(route('miscursos')); ?>" class="nav-link">Mis cursos</a>
                                                        </li>
                                                    </ul>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li>
                                            <a href="<?php echo e(route('miscursos')); ?>" class="has-arrow" aria-expanded="false"><span class="mini-click-non">Mis cursos</span></a>
...
<?php /**PATH /var/www/vhosts/fojal.net/httpdocs/fojal_academia/resources/views/main2.blade.php ENDPATH**/ ?>