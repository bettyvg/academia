...
@section('content')
    ...
    <section>
        @if(isset($alert))
            ...
            <!-- Modal Agregar registro_platicas   -->
                <form action="{{route('registroplatica')}}" method="POST">
                    @csrf
                    <div class="modal" tabindex="-1" role="dialog" name="modal_platicas" id="modal_platicas">
                ...
                <!-- End Modal Agregar registro_platicas  -->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#modificacioninscritos">Consulta de registros</a></li>
                            </ul>

                            <div id="myTabContent" class="tab-content custom-product-edit">

                                <!-- Tabla de registros evaluación   -->
                                <div class="product-tab-list tab-pane fade data-table-area mg-b-15 active in" id="modificacioninscritos">
                                    <div class="col-md-offset-12">
                                        <div class="payment-adress">
                                            <br>
                                            <button type="button" class="btn btn-info pull-right" data-toggle="modal"
                                                    name="agregar_registro" id="agregar_registro"
                                                    data-target="#modal_platicas">Nuevo registro
                                            </button>
