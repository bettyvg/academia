...
@csrf
                                                        ...
                                                        <div class="sparkline13-graph">
                                                            <div class="datatable-dashv1-list custom-datatable-overright">
                                                                ...
                                                                <table id="table" data-toggle="table"
                                                                    ...
                                                                    <tbody>
                                                                    @foreach ($instituciones as $Items)
                                                                        <tr role="row" class="odd">
                                                                            <td class="sorting_1"></td>
                                                                            <td class="sorting_1">{{$Items->nombre_inst}}</td>
                                                                            <td class="sorting_1">{{$Items->direccion}}</td>
                                                                      		<td class="sorting_1">{{$Items->contacto}}</td>
                                                                            <td class="sorting_1">{{$Items->telefono}}</td>
                                                                            <td class="sorting_1">
                                                                                <button type="button"
                                                                                        title="Editar registro"
                                                                                        class="pd-setting-ed">
                                                                                    <a href='editar_institucion/{{$Items->id_institucion}}'>
        ...
        <form action="{{route('instituciones.store')}}" method="POST" class="form-horizontal">{{csrf_field()}}
@csrf
