...
class registrowebModel extends Model
{
    ...
    protected $fillable = ['nombre','apellido_paterno','apellido_materno','fecha_nacimiento','edad', 'genero','rfc', 'curp',
        ...
        'domicilio_empresa','cp_rep_empresa','colonia_empresa','municipio_empresa','region_pm','act_empresarial',
        'scian', 'sedeco','subrama','clase_actividad','tamaño_empresa','telefono','qr','updated_at',
        'created_at'];
}
