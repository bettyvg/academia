                                                                                ...
                                                                                <tr role="row" class="odd">
                                                                                    ...
                                                                                    <td class="sorting_1">
                                                                                        <button type="button"
                                                                                                ...
                                                                                                class="pd-setting-ed editar_ejecutivo">
                                                                                            <a href='editar_ejecutivo/<?php echo e($Items->id_ejecutivo); ?>'><i class="fa fa-pencil-square-o"> </i>  </a></button>
...
<!--!MODAL PARA CREAR EJECUTIVO-->
        <form action="<?php echo e(route('crear_ejecutivos')); ?>" method="POST" class="form-horizontal">
            <?php echo csrf_field(); ?>
 ...
 <!--!FIN DEL MODAL CREAR EJECUTIVO-->

        <!--INICIO MODAL EDITAR EJECUTIVO-->
        <form action="<?php echo e(route('editar_ejecutivos', $Items->id_ejecutivo)); ?>" method="get">
            ...
            <div class="modal" tabindex="-1" role="dialog" name="editar_ejecutivos" id="editar_ejecutivos">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color: whiteSmoke;">
                            <h2 class="modal-title">Editar ejecutivo</h2>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="nombre_ejecutivo_edit" class="col-sm-4">&nbsp;&nbsp;&nbsp;Nombre</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="nombre_ejecutivo_edit" id="nombre_ejecutivo_edit" required="true">
                                            </div>
                                            <br><br>
                                        </div>
                                        <div class="form-group">
                                            <label for="apellido_paterno_edit" class="col-sm-4">&nbsp;&nbsp;Apellido paterno</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="apellido_paterno_edit" id="apellido_paterno_edit" required="true">
                                            </div>
                                            <br><br>
                                        </div>
                                        <div class="form-group">
                                            <label for="apellido_materno_edit" class="col-sm-4">&nbsp;&nbsp;&nbsp;Apellido materno</label>
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="apellido_materno_edit" id="apellido_materno_edit" required="true">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" class="form-control" name="estatus" id="estatus" value="activo">
        ...
        <!--!FIN DEL MODAL EDITAR EJECUTIVO-->
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <h4 style="text-align: center">¿Estas seguro de eliminar el ejecutivo</h4>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/fojal.net/httpdocs/fojal_academia/resources/views/ejecutivos.blade.php ENDPATH**/ ?>