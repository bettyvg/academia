        ...
        <div class="left-sidebar-pro">
            <nav id="" class="">
                <div class="sidebar-header">
                    <a href="<?php echo e(route('inicio2')); ?>"><img class="main-logo" src="img/logo/logo.png" alt="" /></a>
                </div>
            </nav>
        </div>
                                    ...
                                    <?php else: ?>
                                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 ">
                                                ...
                                                <button type="button" class="button-default cart-btn ver_cursos btn btn-secondary" id="<?php echo e($curso->id_cursosonline); ?>" data-target="#modal-curso"
                                                    ...
                                                    <a href="<?php echo e(url('cursodetalle', ['id_cursonline' => $curso->id_cursosonline])); ?>" type="button" class="btn2 btn-primary2">ir al curso</a>
...
<?php echo $__env->make('main2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/fojal.net/httpdocs/fojal_academia/resources/views/cursos/miscursos.blade.php ENDPATH**/ ?>