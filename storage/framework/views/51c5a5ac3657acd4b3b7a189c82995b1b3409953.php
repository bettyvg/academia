                                                                ...
                                                                <div class="col-md-offset-8">
                                                                    <div class="payment-adress">
                                                                        ...
                                                                        <button type="button"
                                                                                ...
                                                                                data-toggle="modal" name="agregar_temas"
                                                                                id="agregar_temas"
                                                                                data-target="#modal_temas">Nuevo tema
                                                                        </button>
                                                                            ...
                                                                            <tr role="row" class="odd">
                                                                                ...
                                                                                <td class="sorting_1">
                                                                                    <button type="button"
                                                                                            ...
                                                                                            class="pd-setting-ed">
                                                                                        <a href='editar_tema/<?php echo e($Items->id_tema); ?>'>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                                ...
                                <div class="col-12">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" name="num_sesion"
                                                       id="num_sesion" required="true">
                                            </div>
                                            <br><br>
                                        </div>
                                        <div class="form-group">
                        ...
                        <div class="modal-footer" style="background-color: whiteSmoke;">
                            <form action="temas" method="POST"><?php echo e(csrf_field()); ?>

                                <button type="submit" name="guardar_temas" id="guardar_temas"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <h4 style="text-align: center">¿Estas seguro de eliminar el tema</h4>
                        <h4 style="text-align: center"><?php echo e(' '.$Items->tema); ?></h4>
                    </div>
                    <div class="modal-footer danger-md">
                        ...
                        <br><br>
                        <form action="delete_tema/<?php echo e($Items->id_tema); ?>" method="POST">
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/fojal.net/httpdocs/fojal_academia/resources/views/cat_temas/temas.blade.php ENDPATH**/ ?>