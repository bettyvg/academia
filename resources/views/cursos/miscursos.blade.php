        ...
        <div class="left-sidebar-pro">
            <nav id="" class="">
                <div class="sidebar-header">
                    <a href="{{route('inicio2')}}"><img class="main-logo" src="img/logo/logo.png" alt="" /></a>
                </div>
            </nav>
        </div>
                                    ...
                                    @else
                                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 ">
                                                ...
                                                <button type="button" class="button-default cart-btn ver_cursos btn btn-secondary" id="{{$curso->id_cursosonline}}" data-target="#modal-curso"
                                                    ...
                                                    <a href="{{url('cursodetalle', ['id_cursonline' => $curso->id_cursosonline])}}" type="button" class="btn2 btn-primary2">ir al curso</a>
